...
function Home() {
    ...
    const likeAPost = (postId: any) => {
        ...
        axios
            .post(
                "https://fullstack-api-node.herokuapp.com/likes",
                { PostId: postId },
                {
                    headers: {
    ...
    useEffect(() => {
        if (!localStorage.getItem("accessToken")) {
            ...
            // 検索窓でのサジェスチョン一覧を取得
            axios
                .get("https://fullstack-api-node.herokuapp.com/posts/suggests")
                .then((response) => {
            ...
            if (keyword) {
                ...
                axios
                    .get(
                        `https://fullstack-api-node.herokuapp.com/posts/search/${keyword}`,
                        {
                            headers: {
                                accessToken: localStorage.getItem(
                                    "accessToken"
                ...
                // 絞り込みなしでの投稿一覧
                axios
                    .get("https://fullstack-api-node.herokuapp.com/posts", {
                        headers: {
                            accessToken: localStorage.getItem(
                                "accessToken"
                            ) as string,
    ...
    return (
        <div>
            ...
            {currentPosts &&
                currentPosts.map((value: any, key: any) => {
                    return (
